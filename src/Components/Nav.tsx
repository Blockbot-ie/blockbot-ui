  ...
  return (
    ...
    <div className="h-screen flex overflow-hidden dark:bg-gray-900">
      ...
      <div className="hidden md:flex md:flex-shrink-0">
          ...
          <div className="flex flex-col flex-grow border-r border-gray-200 pt-5 pb-4 dark:bg-gray-900 overflow-y-auto">
              <div className="flex items-center flex-shrink-0 px-4">
              <img className="h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-logo-indigo-600-mark-gray-800-text.svg" alt="Workflow" />
              </div>
              <div className="mt-5 flex-grow flex flex-col">
              <nav className="flex-1 px-2 dark:bg-gray-900 space-y-1">
                  {/* <!-- Current: "bg-gray-100 text-gray-900", Default: "text-gray-600 hover:bg-gray-50 hover:text-gray-900" --> */}
