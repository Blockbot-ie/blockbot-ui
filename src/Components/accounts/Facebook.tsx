...
const FacebookSocialAuth = (props: any) => {
    ...
    return <>
      <div className="App">
        ...
        <FacebookLogin
          render={renderProps => (
            <button className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50" onClick={renderProps.onClick} disabled={renderProps.disabled}>
