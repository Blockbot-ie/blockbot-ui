        ...
        <nav aria-label="Progress">
            <ol className="overflow-hidden">
                ...
                <a href="#" className="relative flex items-start group">
                    ...
                    <span className="text-xs font-semibold tracking-wide uppercase">Connect Exchange</span>
                    <span className="text-sm text-gray-500">Create api keys and input here</span>
                    </span>
                </a>
                </li>
                ...
                <a href="#" className="relative flex items-start group" aria-current="step">
                    ...
                    <span className="ml-4 min-w-0 flex flex-col">
                    <span className="text-xs font-semibold tracking-wide uppercase text-indigo-600">Choose Strategies</span>
                    <span className="text-sm text-gray-500">Add strategy pairs</span>
                    </span>
                </a>
                </li>
                ...
                <li className="relative">
                    ...
                    <a href="#" className="relative flex items-start group">
                        ...
                        <span className="ml-4 min-w-0 flex flex-col">
                        <span className="text-xs font-semibold tracking-wide uppercase text-gray-500">Review</span>
                        <span className="text-sm text-gray-500">Review your changes and submit</span>
                        </span>
                    </a>
                    </li>
            </ol>
