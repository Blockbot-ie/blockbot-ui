    ...
    <div className="dark:bg-gray-900 px-4 py-5 border-b border-gray-200 sm:px-6">
        <div className="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-nowrap">
            ...
            <div className="hidden sm:block">
                ...
                <button onClick={() => setTab('Open')} className={tab == 'Open' ? 'bg-indigo-100 text-indigo-700 px-3 py-2 font-medium text-sm rounded-md' : 'text-gray-500 hover:text-gray-700 px-3 py-2 font-medium text-sm rounded-md'}>
                    Open
                </button>

                <button onClick={() => setTab('Filled')} className={tab == 'Filled' ? 'bg-indigo-100 text-indigo-700 px-3 py-2 font-medium text-sm rounded-md' : 'text-gray-500 hover:text-gray-700 px-3 py-2 font-medium text-sm rounded-md'} aria-current="page">
                    Filled
                </button>
                </nav>
            </div>
