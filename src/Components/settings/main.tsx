        ...
        <main className="max-w-7xl mx-auto pb-10 lg:py-12 lg:px-8">
            <div className="lg:grid lg:grid-cols-12 lg:gap-x-5">
                ...
                <nav className="space-y-1">
                    ...
                    <Link to="/settings/accounts" className="focus:ring-2 focus:ring-blue-600 text-gray-900 hover:text-gray-900 hover:bg-gray-50 group rounded-md px-3 py-2 flex items-center text-sm font-medium">
                    ...
                    <Link to="/settings/strategies" className="focus:ring-2 focus:ring-blue-600 text-gray-900 hover:text-gray-900 hover:bg-gray-50 group rounded-md px-3 py-2 flex items-center text-sm font-medium">
                    ...
                    <a href="#" className="focus:ring-2 focus:ring-blue-600 bg-gray-50 text-orange-600 hover:bg-white group rounded-md px-3 py-2 flex items-center text-sm font-medium" aria-current="page">
